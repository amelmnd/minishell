...
#    Updated: 2023/10/18 18:36:43 by amennad          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
DIR_LEX = lexer/
SRCS_LEX =	lexer.c lexer_list_manage.c create_lexer_list.c is_bracket.c is_other_operator.c is_quote.c is_dollar.c\
